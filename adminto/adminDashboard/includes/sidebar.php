...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
    <a class="nav-link text-white <?= $page == "inbox.php" ? 'active bg-gradient-primary' : ''; ?>" href="inbox.php">
        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="material-icons opacity-10">mail_outline</i> <!-- or use 'message' for chat -->
        </div>
...
<li class="nav-item">
    <a class="nav-link text-white <?= $page == "shipping.php" ? 'active bg-gradient-primary' : ''; ?>" href="shipping.php">
        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="material-icons opacity-10">local_shipping</i> <!-- or use 'message' for chat -->
        </div>
